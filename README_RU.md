...
| 💬 Расширенные сообщения | Текст, изображения, голосовые сообщения, 200+ эмодзи (8 категорий), стикер-паки Telegram, подтверждения прочтения |
...
13 таблиц, создаются автоматически при первом запуске:
