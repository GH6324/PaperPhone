...
const TRANSLATIONS = {
  zh: {
    ...
    changePasswordDesc: '为了账户安全，建议定期更换密码。新密码至少 6 个字符。',
  ...
  en: {
    ...
    changePasswordDesc: 'For account security, change your password regularly. New password must be at least 6 characters.',
  ...
  ja: {
    ...
    changePasswordDesc: 'アカウントの安全のため、定期的にパスワードを変更することをお勧めします。新しいパスワードは6文字以上です。',
  ...
  ko: {
    ...
    changePasswordDesc: '계정 보안을 위해 정기적으로 비밀번호를 변경하세요. 새 비밀번호는 6자 이상이어야 합니다.',
  ...
  fr: {
    ...
    changePasswordDesc: 'Pour la sécurité de votre compte, changez régulièrement votre mot de passe. Le nouveau mot de passe doit comporter au moins 6 caractères.',
  ...
  de: {
    ...
    changePasswordDesc: 'Für die Kontosicherheit ändern Sie Ihr Passwort regelmäßig. Das neue Passwort muss mindestens 6 Zeichen lang sein.',
  ...
  ru: {
    ...
    changePasswordDesc: 'Для безопасности аккаунта регулярно меняйте пароль. Новый пароль должен содержать не менее 6 символов.',
  ...
  es: {
    ...
    changePasswordDesc: 'Para la seguridad de tu cuenta, cambia tu contraseña regularmente. La nueva contraseña debe tener al menos 6 caracteres.',
